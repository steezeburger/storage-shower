...
const fileTypeMappings = {
    ...
    document: ['pdf', 'doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx', 'txt', 'rtf', 'md', 'csv', 'json', 'xml', 'html', 'css', 'js', 'ts', 'go', 'py', 'java', 'c', 'cpp', 'h', 'rb', 'php'],
...
function updateDetailsPanel(item) {
    ...
    if (item.isDir) {
        ...
        selectedTypeText.textContent = item.extension ?
            `File (.${item.extension})` : 'File';
    }
}
